        ...
        <div className="content-wrapper w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col lg:flex-row justify-between items-end relative z-20">
          ...
          <div className="max-w-[800px] pb-10 lg:pb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
              ...
              <button className="bg-[#101B38]/60 backdrop-blur-md border border-[#C9A84C]/30 text-[#FFFCF7] py-4 px-8 rounded-full text-sm font-semibold tracking-wide transition-all duration-300 hover:border-[#C9A84C]/60 hover:scale-105">
